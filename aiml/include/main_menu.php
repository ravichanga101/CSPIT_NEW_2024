          ...
          <!-- <li><a href="https://www.charusat.ac.in/cspit/">Home</a></li> -->
            ...
            <li><a href="#">Student Services</a>
               <ul>
                  ...
                  <li><a href="https://drive.google.com/drive/folders/1CsUApZYDwfpl44itkin-ubXCAD0-FF5i?usp=drive_link" target="_blank">Syllabus</a></li>                  
            ...
            <li class="menu-has-children">
               ...
               <ul>
                  ...
                  <li><a href="index.php?v=Mobile-App">Mobile and Web Development Lab </a></li>
                  <li><a href="index.php?v=lab_de">Data Engineering Lab </a></li>
