...
<section id="about_us" class="wow fadeInUp">
      <div class="container">
          ...
          <h5>The Department of <?=$data['name_of_dept']?> (Estd. <?=$data['dept_esta']?>) offers <?=$data['dept_b_tech_seats']?> seats in B. Tech. - <?=$data['name_of_dept']?> programme.</h5>
...
<section id="services">
    ...
    <div class="services-content container">
      <div class="row">
          ...
          <p><h3><center>Projects & Grant Recieved</center></h3></p>
          </div>
