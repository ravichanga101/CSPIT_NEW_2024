...
<br/>
		  ...
		  <!--
		  <div style=" display:inline-block; text-align:center;   height:auto; width:100%; margin-top:-50px; " >
            <marquee direction="left" scrolldelay="20" >
		  <b style="color:red;">Announcement: </b><a href="https://charusat.ac.in/documents/pdfs/STTP/brochure_AI_2019.pdf">STTP on Application of AI in engineering</a> 
...
<section id="about_us" class="wow fadeInUp">
      <div class="container">
          ...
          <h5>M & V Patel Department of <?=$data['name_of_dept']?> (Estd. <?=$data['dept_esta']?>) offers <?=$data['dept_b_tech_seats']?> seats in B. Tech. 
        </h5>
...
<section id="services">
    ...
    <div class="services-content container">
      <div class="row">
          ...
          <p><h3><center>Workshop Organized</center></h3></p>
